places = {
    ...
    '树林南': { 'order': 18, 'exists': ['矿泉水'], 'able': True },
    '树林西': { 'order': 19, 'exists': [], 'able': True },
    '树林北': { 'order': 20, 'exists': ['GPS1', '日本刀'], 'able': True },
    ...
    '学校东': { 'order': 29, 'exists': ['矿泉水'], 'able': True },
    '学校南': { 'order': 30, 'exists': [], 'able': True },
    '学校西': { 'order': 31, 'exists': ['绷带'], 'able': True },
...
roles = {
    ...
    '旗上忠胜': { 'order': 34, 'life': 0, 'strength': 100, 'hands': [], 'things': [], 'location': '树林北', 'able': False },
